...
<body>
    ...
    <main>
        <!--  <section class="d-flex align-items-center justify-content-center" style="height: 50vh;">
           <h1>Under Progress, Thank You</h1>
        </section>-->
        <section>
      <div class="about-head-blog">
          <div class="d-flex align-items-center justify-content-center flex-column">
              <h1 > Blog</h1>
              <p class="w-75 text-center">At PanditSoft, we are driven by a passion for excellence in web development and a commitment to delivering unparalleled solutions to our clients. With a team of skilled professionals at the forefront of technology, we specialize in crafting websites that not only meet but exceed the expectations of our clients.</p>
          </div>
      </div>
    </section>
   <div class="container mt-5 mb-3">
    <div class="row">
        <div class="col-md-3">
            <div class="card p-3 mb-2 box-shadow-1 rounded-4">
